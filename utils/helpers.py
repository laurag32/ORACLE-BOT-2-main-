...
def send_tx(web3: Web3, contract, watcher, private_key, public_address):
    """
    Automatically selects method based on protocol, estimates gas dynamically, and sends transaction.
    """
    ...
    try:
        ...
        print(f"[Helpers] Gas estimation failed: {e}")
        tx["gas"] = 210000
